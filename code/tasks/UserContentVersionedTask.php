...
class UserContentVersionedTask extends MigrationTask {

	protected $title = "UserContent Versioned Initial Migration";
	...
	public function run($request) {
		$forms = Versioned::get_by_stage('UserDefinedContent', 'Live');
