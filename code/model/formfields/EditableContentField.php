...
class EditableContentField extends DataObject {
	...
	public function EditSegment() {
		return $this->renderWith('EditableContentField');
	}
	...
	public function getIsModifiedOnStage() {
		...
		$stageVersion = Versioned::get_versionnumber_by_stage('EditableContentField', 'Stage', $this->ID);
		$liveVersion =	Versioned::get_versionnumber_by_stage('EditableContentField', 'Live', $this->ID);
	...
	public function getIcon() {
		return USERCONTENT_DIR . '/images/' . strtolower($this->class) . '.png';
	}
	...
	public function TitleField() {
		$label = _t('EditableContentField.ENTERQUESTION', 'Enter Question');
	...
	public function getFieldConfiguration() {
		...
		if (is_array(self::$allowed_css) && !empty(self::$allowed_css)) {
			...
			$ec = new DropdownField(
				...
				_t('EditableContentField.EXTRACLASSA', 'Extra Styling/Layout'), 
				$cssList, $extraClass
			);
			...
			$ec = new TextField(
				$this->getSettingName('ExtraClass'), 
				_t('EditableContentField.EXTRACLASSB', 'Extra css Class - separate multiples with a space'), 
				$extraClass
			);
		}
		...
		$right = new TextField(
			...
			_t('EditableContentField.RIGHTTITLE', 'Right Title'), 
	...
	public function getFieldValidationOptions() {
		$fields = new FieldList(
			new CheckboxField($this->getFieldName('Required'), _t('EditableContentField.REQUIRED', 'Is this field Required?'), $this->Required),
			new TextField($this->getFieldName('CustomErrorMessage'), _t('EditableContentField.CUSTOMERROR','Custom Error Message'), $this->CustomErrorMessage)
		);
	...
	public function getFormField() {
		user_error("Please implement a getFormField() on your EditableContentClass ". $this->ClassName, E_USER_ERROR);
	}
